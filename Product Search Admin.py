...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('productid', 'productcode')
...
admin.site.register(Certificateapprovals)
admin.site.register(Driverspecifications)
admin.site.register(Electricalspecifications)
admin.site.register(Families)
admin.site.register(Iesfiles)
admin.site.register(Ledcharacteristics)
admin.site.register(Opticalspecifications)
admin.site.register(Physicalconstructions)
admin.site.register(Productgroups)
admin.site.register(Subfamilies)
